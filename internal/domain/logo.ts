...
// Dos variantes: la clara va sobre los fondos oscuros (plantillas dark) y la
// oscura sobre los claros (nota de venta B2B). Se leen una vez al arranque,
// igual que las plantillas HTML.
